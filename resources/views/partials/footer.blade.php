                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 footer--widget footer--widget-about">
                        ...
                        <div class="footer--widget-content">
                            <ul class="list-unstyled mb-0 bankDetail">
                                ...
                                <li>
                                    <a href="https://www.paypal.com/signin?country.x=DE&locale.x=en_US&langTgl=en"
                                        class="paypal social-icon paypal-size pay-detail" title="paypal" target="blank">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 footer--widget footer--widget-recent">
                        ...
                        <div class="footer--widget-content">
                            <div class="entry">
                                ...
                                <div class="entry--meta">Feb 27, 2017</div>
                            </div><!-- .entry end -->
                            <div class="entry">
                                <div class="entry--title">
                            ...
                            <div class="entry">
                                <div class="entry--title">
                                    <a href="#">New subway line has most advanced</a>
                                </div>
                                <div class="entry--meta">Feb 27, 2017</div>
                            </div><!-- .entry end -->
                        </div>
        ...
        <div class="footer--widget-content">
            <div class="row ">
                <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 social-icons iconStyle">
                    <a href="islamtodayhadeeschannel@gmail.com" class="facebook iconStyle" title="Facebook"
                        target="blank">
                        <i class="fa fa-facebook"></i>
                    </a>
                    <a href="@hadeeschannel" class="twitter" title="twitter" target="blank">
